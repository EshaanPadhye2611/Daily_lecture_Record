...
<form action="" method="POST">
    ...
    <input type="date" id="date" name="date" required>
        ...
        <a href="kanchan-DLR.php"<button name= "DLR_btn"type="Enter DLR">Enter DLR</button>
...
if(isset($_POST["submit_btn"])){
  ...
  if($query){
    ...
    window.location.href='ITF-03.php';
  </script>";
  }
}
}
if(isset($_POST["DLR_btn"])){
    header("Location:kanchan-DLR.php");
}
