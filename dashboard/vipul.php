...
<style>
    ...
    form {
        ...
        button[type="submit"], button[type="button"] {
            ...
            cursor: pointer;
            font-size: 16px;
            margin-top: 10px; /* Adjust the margin to separate the buttons */
        }
...
<div class="container">
    <header>
        ...
        <h2 class="text-center bg-white p-3"> <span class="emp_name"><?= ucwords($user['full_name']) ?></span><br>
...
<form action="" method="POST">
    ...
    <input type="date" id="date" name="date" required>
        ...
        <a href="vipul-DLR.php">
        <button name="Enter DLR" type="button">Enter DLR</button>
    </a>
...
if(isset($_POST["submit_btn"])){
  ...
  if($query){
    ...
    window.location.href='vipul.php';
  </script>";
  }
}
}
